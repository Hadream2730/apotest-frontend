  ...
  return (
    <section className="my-5">
      <div className="container">
        <div className="grid grid-flex-row grid-cols-12 lg:grid-cols-12 gap-6">
          <div className="col-span-12 sm:col-span-6 lg:col-span-4">
            <div className="group banner relative bg-[#ff9987] overflow-hidden  rounded-2xl rounded-2xl">
              <Image
          ...
          <div className="col-span-12 sm:col-span-6 lg:col-span-4">
            <div className="group banner relative bg-[#f1b1b5] overflow-hidden  rounded-2xl">
              <Image
                className="w-full group-hover:opacity-0 transition-all"
          ...
          <div className="col-span-12 sm:col-span-6 lg:col-span-4">
            <div className="group banner relative bg-[#85ccd6] overflow-hidden  rounded-2xl">
              <Image
                className="w-full group-hover:opacity-0 transition-all"
          ...
          <div className="col-span-12 sm:col-span-6 lg:col-span-4">
            <div className="group banner relative bg-[#f9d395] overflow-hidden  rounded-2xl">
              <Image
                className="w-full group-hover:opacity-0 transition-all"
          ...
          <div className="col-span-12 sm:col-span-6 lg:col-span-4">
            <div className="group banner relative bg-[#cccccc] overflow-hidden  rounded-2xl">
              <Image
                className="w-full group-hover:opacity-0 transition-all"
